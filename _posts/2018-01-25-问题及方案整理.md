...
# 示例操作
#   xcodebuild clean -workspace ysbuyer.xcworkspace -scheme ysbuyer -configuration DEBUG
#   xcodebuild archive -workspace ysbuyer.xcworkspace -scheme ysbuyer -archivePath './archivePath' -configuration DEBUG
#   xcodebuild -exportArchive -archivePath archivePath.xcarchive -exportOptionsPlist DevelopmentExportOptionsPlist.plist -exportPath ysbuyer.ipa
